...
class BookingMapper extends ClassMapperBase<Booking> {
  ...
  static const Field<Booking, double> _f$fees = Field(
    'fees',
    _$fees,
    opt: true,
  );
  static bool _$top(Booking v) => v.top;
  static const Field<Booking, bool> _f$top = Field(
    'top',
    _$top,
    opt: true,
    def: false,
  ...
  static const Field<Booking, DateTime> _f$bookingDate = Field(
    'bookingDate',
    _$bookingDate,
  );
  static BookingStatus _$status(Booking v) => v.status;
  static const Field<Booking, BookingStatus> _f$status = Field(
    'status',
    _$status,
  );
  static String? _$notes(Booking v) => v.notes;
  static const Field<Booking, String> _f$notes = Field(
    'notes',
    _$notes,
    opt: true,
  );
  ...
  static const Field<Booking, int> _f$numberOfGuests = Field(
    'numberOfGuests',
    _$numberOfGuests,
  );
