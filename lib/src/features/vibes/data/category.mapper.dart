...
mixin EventCategoryMappable {
  String toJson() {
    return EventCategoryMapper.ensureInitialized()
        .encodeJson<EventCategory>(this as EventCategory);
  }

  Map<String, dynamic> toMap() {
    return EventCategoryMapper.ensureInitialized()
        .encodeMap<EventCategory>(this as EventCategory);
  }
  ...
  EventCategoryCopyWith<EventCategory, EventCategory, EventCategory>
      get copyWith => _EventCategoryCopyWithImpl<EventCategory, EventCategory>(
          this as EventCategory, $identity, $identity);
  @override
  String toString() {
    return EventCategoryMapper.ensureInitialized()
        .stringifyValue(this as EventCategory);
  }

  @override
  bool operator ==(Object other) {
    return EventCategoryMapper.ensureInitialized()
        .equalsValue(this as EventCategory, other);
  }

  @override
  int get hashCode {
    return EventCategoryMapper.ensureInitialized()
        .hashValue(this as EventCategory);
  }
}
