...
class ShowSection extends StatelessWidget {
  ShowSection({super.key});

  final data = [
    Sports(category: "Seating Type", title: "First Come"),
    Sports(category: "Age Limit", title: "+18"),
    Sports(category: "Amenities", title: "Lounge Bar, Snacks"),
