...
class HappeningTonight extends StatelessWidget {
        ...
        slivers: [
          SliverAppBar.large(
            ...
            bottom: PreferredSize(
              ...
              child: SizedBox(
                height: 54, // 2. Match the SizedBox height
                child: ListView.builder(
                  // 3. Significantly reduce vertical padding, or use symmetric(vertical)
                  padding: const EdgeInsets.symmetric(
                    horizontal: 16,
                    vertical:
                        8, // Reduced from 16 to 8 (8px top + 8px bottom = 16px total padding)
                  ),
                  itemCount: 8,
